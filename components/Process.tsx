              ...
              <Reveal key={index} delay={index * 0.1} variant="slide-up" width="100%">
                ...
                >
                  ...
                  <div className="w-full">
                      ...
                      <p className="text-zinc-500 text-sm leading-relaxed px-2">{step.desc}</p>
                      
                      {/* Active Tip */}
                      <div className={`mt-4 overflow-hidden transition-all duration-500 ${activeStep === index ? 'max-h-20 opacity-100' : 'max-h-0 opacity-0'}`}>
                         <div className="flex items-center justify-center gap-2 text-pink-400 text-xs font-bold">
